...
{
    unsigned int POLY_MASK_HERE_1 = 0x1A1B1C1D;
    unsigned int POLY_MASK_HERE_2 = 0x12233456;
    int temp;
    static unsigned int lfsr_1 = 0xABCDCDBA;
//    static unsigned int lfsr_2 = 0xEFEFBCBC;
    static unsigned int lfsr_2 = 0xCBCBCBCB;
...
static void get_random_bits(uint64_t *x)
{
    unsigned int i, j;
    uint64_t temp;
    // for(i=0;i<length;i++)
