...
{
    unsigned int POLY_MASK_HERE_1 = 0x0123ABCD;
    unsigned int POLY_MASK_HERE_2 = 0x66AABBCC;
    int temp;
    static unsigned int lfsr_1 = 0x11AA22BB;
    static unsigned int lfsr_2 = 0x33CC44DD;
